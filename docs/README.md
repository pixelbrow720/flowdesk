...
| 04 | [Engine](04-engine.md) | The compute core: Black-76, IV, exposure, field, levels, snapshot, FLUX, surface |
...
- [`research/archive/`](research/archive/) — superseded raw methodology drafts (FLUX, SpotGamma reverse-engineering, FlowGreeks blueprint, mega-riset 1 & 2), kept for provenance only. The `verified/` package wins on any disagreement.
